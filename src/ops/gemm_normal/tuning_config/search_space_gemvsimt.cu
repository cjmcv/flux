...
static int search_space_gemvsimt = []() {
  ...
  ins.add({0,(int16_t)ME::GemvSimt,(int16_t)ME::BF16, (int16_t)ME::BF16, (int16_t)ME::BF16, (int16_t)ME::FP32, (int16_t)ME::RCR, (int16_t)ME::Sm80}, /*op*/[]() { return new GemvSimtImpl</*meta*/cutlass::bfloat16_t, cutlass::bfloat16_t, cutlass::bfloat16_t, float, layout::RowMajor, arch::Sm80,/*hparam*/8,128,128>();});
  return 0;
}();
}
