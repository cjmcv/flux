...
static int search_space_gemmbolckscalefp8 = []() {
  ...
  ins.add({0,(int8_t)ME::GemmBolckScaleFp8,(int8_t)ME::E4M3, (int8_t)ME::E4M3, (int8_t)ME::BF16, (int8_t)ME::FP32, (int8_t)ME::RCR, (int8_t)ME::Sm90}, /*op*/[]() { return new GemmBlockScaleFp8Impl</*meta*/cutlass::float_e4m3_t, cutlass::float_e4m3_t, cutlass::bfloat16_t, float, layout::RowMajor, layout::ColumnMajor, layout::RowMajor, arch::Sm90,/*hparam*/cute::Shape<cute::_1,cute::_2,cute::_1>,gemm::kernel::detail::RasterOrderOptions::Heuristic,2>();});
