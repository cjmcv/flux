...
static int search_space_gemmw4a16sm90 = []() {
  ...
  ins.add({0,(int16_t)ME::GemmW4A16,(int16_t)ME::BF16, (int16_t)ME::S8, (int16_t)ME::BF16, (int16_t)ME::FP32, (int16_t)ME::RCR, (int16_t)ME::Sm90}, /*op*/[]() { return new GemmW4A16Sm90Impl</*meta*/cutlass::bfloat16_t, int8_t, cutlass::bfloat16_t, float, layout::RowMajor, layout::ColumnMajor, layout::RowMajor, arch::Sm90,/*hparam*/cute::Shape<cute::_128,cute::_128>,cute::Shape<cute::_1,cute::_2,cute::_1>,cutlass::gemm::KernelTmaWarpSpecializedCooperative,cutlass::epilogue::TmaWarpSpecializedCooperative,cutlass::gemm::PersistentScheduler>();});
  return 0;
}();
}
