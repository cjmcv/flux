...
#     return torch.equal(x.view(torch.int8), y.view(torch.int8))
    ...
    # "RING_MODE_MAP",    "initialize_distributed",    "NNODES",    "init_local_groups",    "is_local_tp_group_initialized",    "run_perf",
    # "TP_GROUP",    "empty_non_determinisitc",    "all_gather_into_tensor_with_fp8",    "bitwise_eq",
    # "clone_with_fp8",    "rand_with_fp8",    "zeros_with_fp8",
    # "ones_with_fp8",    "_make_tensor",
    # "generate_data",
