...
template <typename T,
  ...
  for (int i_1 = 0; i_1 < 2; ++i_1) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((i_1 * 1024) + ((((int)threadIdx.x) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 512)])), (&(B[((((((int)bx) * 196608) + (i_1 * 98304)) + ((((int)threadIdx.x) >> 2) * 3072)) + ((((int)threadIdx.x) & 3) * 8))])));
  }
  tl::cp_async_commit();
  for (int k = 0; k < 95; ++k) {
    tl::cp_async_wait<0>();
    ...
    for (int i_2 = 0; i_2 < 2; ++i_2) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((i_2 * 1024) + ((((int)threadIdx.x) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 512)])), (&(B[((((((((int)bx) * 196608) + (i_2 * 98304)) + ((((int)threadIdx.x) >> 2) * 3072)) + (k * 32)) + ((((int)threadIdx.x) & 3) * 8)) + 32)])));
    }
    tl::cp_async_commit();
  }
  tl::cp_async_wait<0>();
...
#define LAUNCH_INFO_linear_gemm_add_tl_1_1024_3072 dim3(16, 1, 1), dim3(128, 1, 1), 5120, stream

// latency: 0.07351 ms vs [ref-0.03911 sim-1.0], idx: 7