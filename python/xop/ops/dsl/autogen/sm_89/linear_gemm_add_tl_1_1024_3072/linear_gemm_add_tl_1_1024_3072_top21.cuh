...
template <typename T,
  ...
  for (int k = 0; k < 24; ++k) {
    ...
    for (int i_1 = 0; i_1 < 2; ++i_1) {
      ...
      if ((((i_1 * 8) + (((int)threadIdx.x) >> 4)) < 1)) {
        condval = *(uint4*)(A + ((((i_1 * 24576) + ((((int)threadIdx.x) >> 4) * 3072)) + (k * 128)) + ((((int)threadIdx.x) & 15) * 8)));
      } else {
    ...
    for (int i_2 = 0; i_2 < 8; ++i_2) {
      *(uint4*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_2 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(B + (((((((int)bx) * 196608) + (i_2 * 24576)) + ((((int)threadIdx.x) >> 4) * 3072)) + (k * 128)) + ((((int)threadIdx.x) & 15) * 8)));
    }
    __syncthreads();
  ...
  for (int i_3 = 0; i_3 < 4; ++i_3) {
    ...
    if (((((i_3 & 1) * 8) + ((((int)threadIdx.x) & 31) >> 2)) < 1)) {
      condval_1 = *(uint1*)(R + (((((((i_3 & 1) * 8192) + (((((int)threadIdx.x) & 31) >> 2) * 1024)) + (((int)bx) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + ((i_3 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    } else {
    ...
    *(float2*)(R_local + (i_3 * 2)) = condval_2;
  }
  __syncthreads();
  #pragma unroll
...
// latency: 0.03755 ms vs [ref-0.03886 sim-1.0], idx: 35