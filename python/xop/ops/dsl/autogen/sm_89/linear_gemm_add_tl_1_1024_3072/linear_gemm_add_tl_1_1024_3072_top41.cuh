...
template <typename T,
  ...
  for (int i_1 = 0; i_1 < 2; ++i_1) {
    tl::cp_async_gs<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((i_1 * 1024) + ((((int)threadIdx.x) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 1024)])), (&(B[((((((int)bx) * 196608) + (i_1 * 98304)) + ((((int)threadIdx.x) >> 2) * 3072)) + ((((int)threadIdx.x) & 3) * 8))])));
  }
  tl::cp_async_commit();
  for (int k = 0; k < 95; ++k) {
    __syncthreads();
    ...
    for (int i_2 = 0; i_2 < 2; ++i_2) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)buf_dyn_shmem)[((((((((k + 1) & 1) * 2048) + (i_2 * 1024)) + ((((int)threadIdx.x) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 1024)])), (&(B[((((((((int)bx) * 196608) + (i_2 * 98304)) + ((((int)threadIdx.x) >> 2) * 3072)) + (k * 32)) + ((((int)threadIdx.x) & 3) * 8)) + 32)])));
    }
    tl::cp_async_commit();
    tl::cp_async_wait<1>();
    __syncthreads();
...
// latency: 0.04534 ms vs [ref-0.03898 sim-1.0], idx: 11