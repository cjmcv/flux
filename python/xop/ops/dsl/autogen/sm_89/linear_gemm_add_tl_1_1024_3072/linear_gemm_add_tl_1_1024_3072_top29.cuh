  ...
  for (int k = 0; k < 96; ++k) {
    ...
    *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 3) * 32) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 2048)) = condval;
    ...
    for (int i_1 = 0; i_1 < 2; ++i_1) {
      *(uint4*)(((bfloat16_t*)buf_dyn_shmem) + ((((i_1 * 1024) + ((((int)threadIdx.x) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(B + (((((((int)bx) * 196608) + (i_1 * 98304)) + ((((int)threadIdx.x) >> 2) * 3072)) + (k * 32)) + ((((int)threadIdx.x) & 3) * 8)));
    }
    __syncthreads();
...
// latency: 0.04139 ms vs [ref-0.03892 sim-1.0], idx: 3