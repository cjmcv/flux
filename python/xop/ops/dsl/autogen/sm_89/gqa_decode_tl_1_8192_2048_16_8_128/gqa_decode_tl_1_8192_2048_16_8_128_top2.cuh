  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  if (0 < condval_1) {
    ...
    for (int i_3 = 0; i_3 < 4; ++i_3) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_3 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 12288)])), (&(V[(((((((int64_t)i_3) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8))])), ((((((((int)threadIdx.x) >> 4) + (((int)bz) * (actual_kv_seqlen >> 2))) >> 3) + i_3) < 1024) && (0 <= (((i_3 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
  }
  int condval_2;
  ...
  for (int k = 0; k < (((condval_2 + 31) >> 5) - 1); ++k) {
    #pragma unroll
    ...
    for (int ki = 0; ki < 8; ++ki) {
      ...
      for (int i_5 = 0; i_5 < 2; ++i_5) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((ki >> 2) * 2048) + (i_5 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_5 * 8));
      }
      for (int j = 0; j < 2; ++j) {
    ...
    for (int i_6 = 0; i_6 < 4; ++i_6) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_6 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(K[(((((((((int64_t)k) * (int64_t)32768) + (((int64_t)i_6) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)32768)])), ((((((k * 32) + (i_6 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8160) && (-32 <= ((((k * 32) + (i_6 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_7 = 0; i_7 < 16; ++i_7) {
      ...
      float condval_3;
      if ((((((k * 32) + ((i_7 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1)) < condval_4)) {
        condval_3 = acc_s[i_7];
      } else {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_8 = 0; i_8 < 2; ++i_8) {
      ...
      for (int rv = 0; rv < 8; ++rv) {
        scores_max_clear[i_8] = max(scores_max_clear[i_8], acc_s[((((rv & 3) * 4) + (i_8 * 2)) + (rv >> 2))]);
      }
    ...
    for (int i_12 = 0; i_12 < 2; ++i_12) {
      ...
      for (int rv_1 = 0; rv_1 < 8; ++rv_1) {
        scores_sum[i_12] = (scores_sum[i_12] + acc_s[((((rv_1 & 3) * 4) + (i_12 * 2)) + (rv_1 >> 2))]);
      }
    ...
    for (int ki_1 = 0; ki_1 < 2; ++ki_1) {
      for (int i_16 = 0; i_16 < 8; ++i_16) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((i_16 >> 2) * 2048) + (ki_1 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_16 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_16 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 12288)])) + 0, B_local_1 + (i_16 * 8));
      }
    ...
    for (int i_17 = 0; i_17 < 4; ++i_17) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_17 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 12288)])), (&(V[(((((((((int64_t)k) * (int64_t)32768) + (((int64_t)i_17) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)32768)])), ((((((k * 32) + (i_17 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8160) && (-32 <= ((((k * 32) + (i_17 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
  }
  int condval_5;
  ...
  if (1 <= condval_5) {
    ...
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((ki_2 >> 2) * 2048) + (i_19 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_2 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_19 * 8));
      }
    ...
    for (int i_20 = 0; i_20 < 16; ++i_20) {
      ...
      float condval_6;
      if ((((((((condval_7 + 31) >> 5) * 32) + ((i_20 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_20 & 1)) < (condval_8 + 32))) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
    ...
    for (int i_21 = 0; i_21 < 2; ++i_21) {
      ...
      for (int rv_2 = 0; rv_2 < 8; ++rv_2) {
        scores_max_clear_1[i_21] = max(scores_max_clear_1[i_21], acc_s[((((rv_2 & 3) * 4) + (i_21 * 2)) + (rv_2 >> 2))]);
      }
    ...
    for (int i_25 = 0; i_25 < 2; ++i_25) {
      ...
      for (int rv_3 = 0; rv_3 < 8; ++rv_3) {
        scores_sum[i_25] = (scores_sum[i_25] + acc_s[((((rv_3 & 3) * 4) + (i_25 * 2)) + (rv_3 >> 2))]);
      }
    ...
    for (int ki_3 = 0; ki_3 < 2; ++ki_3) {
      for (int i_29 = 0; i_29 < 8; ++i_29) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((i_29 >> 2) * 2048) + (ki_3 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_29 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_29 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 12288)])) + 0, B_local_1 + (i_29 * 8));
      }
...
// selected_hparams: [32, 64, 4, 1, 128].
// smem: 0 bytes.
...
// latency: 0.05557 ms vs [ref-0.05529 sim-0.99974], idx: 9