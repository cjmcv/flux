  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  if (0 < valid_kv_seqlen) {
    ...
    for (int i_3 = 0; i_3 < 8; ++i_3) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_3 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 16384)])), (&(V[((((i_3 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8))])));
    }
    tl::cp_async_commit();
  }
  for (int k = 0; k < (((valid_kv_seqlen + 63) >> 6) - 1); ++k) {
    #pragma unroll
    ...
    for (int i_7 = 0; i_7 < 32; ++i_7) {
      float condval_1;
      if ((((((k * 64) + ((i_7 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1)) < valid_kv_seqlen)) {
        condval_1 = acc_s[i_7];
      } else {
  ...
  if (1 <= valid_kv_seqlen) {
    ...
    for (int i_20 = 0; i_20 < 32; ++i_20) {
      float condval_2;
      if ((((((((valid_kv_seqlen + 63) >> 6) * 64) + ((i_20 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_20 & 1)) < (valid_kv_seqlen + 64))) {
...
// latency: 0.09713 ms vs [ref-0.05566 sim-0.99988], idx: 15