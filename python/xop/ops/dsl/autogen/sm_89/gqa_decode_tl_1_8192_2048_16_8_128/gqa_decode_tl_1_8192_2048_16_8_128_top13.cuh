  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  for (int k = 0; k < (((condval_3 + 63) >> 6) - 2); ++k) {
    ...
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      int condval_5;
      if ((((int)bz) == 7)) {
        condval_5 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 3)));
      } else {
        condval_5 = (actual_kv_seqlen >> 3);
      }
      float condval_4;
  ...
  if ((((int)threadIdx.x) % 4) == 0) {
    ...
    for (int i_46 = 0; i_46 < 2; ++i_46) {
      if (((((((int)threadIdx.x) >> 5) * 8) + (i_46 * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 128) + (i_46 * 64)) + (((int)by) * 16)) + (((((int)threadIdx.x) & 31) >> 2) * 8)) + ((int)bz))] = ((bfloat16_t)logsum[i_46]);
      }
    }
  }
  __syncthreads();
...
// selected_hparams: [64, 64, 8, 2, 128].
// smem: 0 bytes.
...
// latency: 0.06497 ms vs [ref-0.05546 sim-0.99988], idx: 25