  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  if (0 < valid_kv_seqlen) {
    ...
    for (int i_3 = 0; i_3 < 2; ++i_3) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 1024) + (i_3 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 10240)])), (&(V[((((i_3 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8))])));
    }
    tl::cp_async_commit();
  }
  for (int k = 0; k < (((valid_kv_seqlen + 15) >> 4) - 1); ++k) {
    #pragma unroll
    ...
    for (int i_5 = 0; i_5 < 2; ++i_5) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 1024) + (i_5 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(K[((((((((int64_t)k) * (int64_t)16384) + (((int64_t)i_5) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)16384)])), (k < 511));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      float condval_1;
      if ((((((k * 16) + ((i_6 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1)) < valid_kv_seqlen)) {
        condval_1 = acc_s[i_6];
      } else {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_7 = 0; i_7 < 2; ++i_7) {
      ...
      for (int rv = 0; rv < 4; ++rv) {
        scores_max_clear[i_7] = max(scores_max_clear[i_7], acc_s[((((rv & 1) * 4) + (i_7 * 2)) + (rv >> 1))]);
      }
    ...
    for (int i_10 = 0; i_10 < 8; ++i_10) {
      acc_s[i_10] = exp2f(((acc_s[i_10] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_10 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_11 = 0; i_11 < 2; ++i_11) {
      ...
      for (int rv_1 = 0; rv_1 < 4; ++rv_1) {
        scores_sum[i_11] = (scores_sum[i_11] + acc_s[((((rv_1 & 1) * 4) + (i_11 * 2)) + (rv_1 >> 1))]);
      }
      scores_sum[i_11] = tl::AllReduce<tl::SumOp, 4, 1, 0>::run(scores_sum[i_11]);
    }
    #pragma unroll
    ...
    for (int i_13 = 0; i_13 < 2; ++i_13) {
      ...
      *(uint2*)(acc_s_cast + (i_13 * 4)) = __1;
    }
    #pragma unroll
    for (int i_14 = 0; i_14 < 64; ++i_14) {
      acc_o[i_14] = (acc_o[i_14] * scores_scale[((i_14 & 3) >> 1)]);
    }
    tl::cp_async_wait<0>();
    __syncthreads();
    for (int i_15 = 0; i_15 < 8; ++i_15) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((i_15 >> 2) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_15 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_15 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 10240)])) + 0, B_local_1 + (i_15 * 8));
    }
    for (int j = 0; j < 8; ++j) {
    ...
    for (int i_16 = 0; i_16 < 2; ++i_16) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 1024) + (i_16 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 10240)])), (&(V[((((((((int64_t)k) * (int64_t)16384) + (((int64_t)i_16) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)16384)])), (k < 511));
    }
    tl::cp_async_commit();
  }
  if (1 <= valid_kv_seqlen) {
    ...
    for (int i_17 = 0; i_17 < 2; ++i_17) {
      ...
      *(float4*)(acc_s + (i_17 * 4)) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
    }
    tl::cp_async_wait<0>();
    __syncthreads();
    for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
      ...
      tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[((((((((ki_1 >> 2) * 1024) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_1 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_1 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + 0);
      tl::mma_sync<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + 0), reinterpret_cast<const unsigned*>(A_local + 0), reinterpret_cast<const unsigned*>(B_local + 0));
      tl::mma_sync<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + 4), reinterpret_cast<const unsigned*>(A_local + 0), reinterpret_cast<const unsigned*>(B_local + 4));
    }
    #pragma unroll
    for (int i_18 = 0; i_18 < 8; ++i_18) {
      float condval_2;
      if ((((((((valid_kv_seqlen + 15) >> 4) * 16) + ((i_18 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_18 & 1)) < (valid_kv_seqlen + 16))) {
        condval_2 = acc_s[i_18];
      } else {
        condval_2 = -CUDART_INF_F;
      }
      acc_s[i_18] = condval_2;
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
    ...
    for (int i_19 = 0; i_19 < 2; ++i_19) {
      ...
      for (int rv_2 = 0; rv_2 < 4; ++rv_2) {
        scores_max_clear_1[i_19] = max(scores_max_clear_1[i_19], acc_s[((((rv_2 & 1) * 4) + (i_19 * 2)) + (rv_2 >> 1))]);
      }
    ...
    for (int i_23 = 0; i_23 < 2; ++i_23) {
      ...
      for (int rv_3 = 0; rv_3 < 4; ++rv_3) {
        scores_sum[i_23] = (scores_sum[i_23] + acc_s[((((rv_3 & 1) * 4) + (i_23 * 2)) + (rv_3 >> 1))]);
      }
      scores_sum[i_23] = tl::AllReduce<tl::SumOp, 4, 1, 0>::run(scores_sum[i_23]);
    }
    #pragma unroll
    ...
    for (int i_25 = 0; i_25 < 2; ++i_25) {
      uint2 __2;
      float4 v__1 = *(float4*)(acc_s + (i_25 * 4));
    ...
    for (int i_27 = 0; i_27 < 8; ++i_27) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((i_27 >> 2) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_27 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_27 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 10240)])) + 0, B_local_1 + (i_27 * 8));
    }
  ...
  for (int i_29 = 0; i_29 < 2; ++i_29) {
    logsum[i_29] = (log2f(logsum[i_29]) + (scores_max[i_29] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/));
  }
  __syncthreads();
  #pragma unroll
  for (int i_30 = 0; i_30 < 32; ++i_30) {
    if (((((((int)threadIdx.x) >> 5) * 8) + ((i_30 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
      uint1 __3;
      float2 v__2 = *(float2*)(acc_o + (i_30 * 2));
      (reinterpret_cast<__nv_bfloat162*>(&__3))[0] = __float22bfloat162_rn(((float2*)(&v__2))[0]);
      *(uint1*)(O_shared_local_cast + 0) = __3;
      *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_30 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_30 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(O_shared_local_cast + 0);
    }
  }
  __syncthreads();
...
#define LAUNCH_INFO_gqa_decode_tl_1_8192_2048_16_8_128 dim3(1, 8, 1), dim3(128, 1, 1), 24576, stream

// latency: 0.1635 ms vs [ref-0.05571 sim-0.99985], idx: 0