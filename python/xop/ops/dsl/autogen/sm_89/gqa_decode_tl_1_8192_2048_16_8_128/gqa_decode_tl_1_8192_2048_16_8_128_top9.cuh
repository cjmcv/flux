...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_2048_16_8_128__0(const int bx, const int by, const int bz,
  ...
  if constexpr (SUB_KERNEL_ID == 0) { if (bx >= 1 || by >= 8 || bz >= 4 || threadIdx.x >= 128) { return; } }
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  if ((((int)bz) == 3)) {
    ...
    condval_1 = (actual_kv_seqlen >> 2);
  }
  if (0 < condval_1) {
    #pragma unroll
    for (int i_2 = 0; i_2 < 8; ++i_2) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_2 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(K[(((((((int64_t)i_2) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8))])), (((((i_2 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8192) && (0 <= (((i_2 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_3 = 0; i_3 < 8; ++i_3) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_3 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 24576)])), (&(V[(((((((int64_t)i_3) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8))])), (((((i_3 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8192) && (0 <= (((i_3 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
  }
  int condval_2;
  if ((((int)bz) == 3)) {
    condval_2 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
  } else {
    condval_2 = (actual_kv_seqlen >> 2);
  }
  if (64 < condval_2) {
    #pragma unroll
    for (int i_4 = 0; i_4 < 8; ++i_4) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_4 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 16384)])), (&(K[((((((((int64_t)i_4) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)65536)])), (((((i_4 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8128) && (-64 <= (((i_4 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_5 = 0; i_5 < 8; ++i_5) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_5 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 32768)])), (&(V[((((((((int64_t)i_5) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)65536)])), (((((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8128) && (-64 <= (((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
  }
  int condval_3;
  if ((((int)bz) == 3)) {
    condval_3 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
  } else {
    condval_3 = (actual_kv_seqlen >> 2);
  }
  for (int k = 0; k < (((condval_3 + 63) >> 6) - 2); ++k) {
    #pragma unroll
    ...
    for (int ki = 0; ki < 8; ++ki) {
      ...
      for (int i_7 = 0; i_7 < 4; ++i_7) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((k & 1) * 8192) + ((ki >> 2) * 4096)) + (i_7 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_7 * 8));
      }
      for (int j = 0; j < 4; ++j) {
    ...
    for (int i_8 = 0; i_8 < 8; ++i_8) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((k & 1) * 8192) + (((((int)threadIdx.x) & 15) >> 3) * 4096)) + (i_8 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(K[(((((((((int64_t)k) * (int64_t)65536) + (((int64_t)i_8) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)131072)])), ((((((k * 64) + (i_8 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8064) && (-128 <= ((((k * 64) + (i_8 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      int condval_5;
      if ((((int)bz) == 3)) {
        condval_5 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
      } else {
        condval_5 = (actual_kv_seqlen >> 2);
      }
      float condval_4;
      if ((((((k * 64) + ((i_9 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1)) < condval_5)) {
        condval_4 = acc_s[i_9];
      } else {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_10 = 0; i_10 < 2; ++i_10) {
      scores_max_clear[i_10] = -CUDART_INF_F;
      #pragma unroll
      for (int rv = 0; rv < 16; ++rv) {
        scores_max_clear[i_10] = max(scores_max_clear[i_10], acc_s[((((rv & 7) * 4) + (i_10 * 2)) + (rv >> 3))]);
      }
      scores_max_clear[i_10] = tl::AllReduce<tl::MaxOp, 4, 1, 0>::run(scores_max_clear[i_10]);
      scores_max[i_10] = max(scores_max[i_10], scores_max_clear[i_10]);
    }
    #pragma unroll
    ...
    for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
      for (int i_18 = 0; i_18 < 8; ++i_18) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((k & 1) * 8192) + ((i_18 >> 2) * 4096)) + (ki_1 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_18 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_18 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 24576)])) + 0, B_local_1 + (i_18 * 8));
      }
    ...
    for (int i_19 = 0; i_19 < 8; ++i_19) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((k & 1) * 8192) + (((((int)threadIdx.x) & 15) >> 3) * 4096)) + (i_19 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 24576)])), (&(V[(((((((((int64_t)k) * (int64_t)65536) + (((int64_t)i_19) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)131072)])), ((((((k * 64) + (i_19 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8064) && (-128 <= ((((k * 64) + (i_19 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
  }
  int condval_6;
  if ((((int)bz) == 3)) {
    condval_6 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
  } else {
    condval_6 = (actual_kv_seqlen >> 2);
  }
  if (65 <= condval_6) {
    #pragma unroll
    for (int i_20 = 0; i_20 < 8; ++i_20) {
      float broadcast_var_6 = 0x0p+0f/*0.000000e+00*/;
      *(float4*)(acc_s + (i_20 * 4)) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
    }
    tl::cp_async_wait<1>();
    __syncthreads();
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      ...
      for (int i_21 = 0; i_21 < 4; ++i_21) {
        int condval_7;
        if ((((int)bz) == 3)) {
          condval_7 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_7 = (actual_kv_seqlen >> 2);
        }
        int condval_8;
        if ((((int)bz) == 3)) {
          condval_8 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_8 = (actual_kv_seqlen >> 2);
        }
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((((condval_8 + 63) & 127) >> 6) * 8192) + ((ki_2 >> 2) * 4096)) + (i_21 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_2 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_21 * 8));
      }
    ...
    for (int i_22 = 0; i_22 < 32; ++i_22) {
      int condval_10;
      if ((((int)bz) == 3)) {
        condval_10 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
      } else {
        condval_10 = (actual_kv_seqlen >> 2);
      }
      int condval_11;
      if ((((int)bz) == 3)) {
        condval_11 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
      } else {
        condval_11 = (actual_kv_seqlen >> 2);
      }
      float condval_9;
      if ((((((((condval_10 + 63) >> 6) * 64) + ((i_22 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_22 & 1)) < (condval_11 + 128))) {
        condval_9 = acc_s[i_22];
      } else {
        condval_9 = -CUDART_INF_F;
      }
      acc_s[i_22] = condval_9;
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
    ...
    for (int i_23 = 0; i_23 < 2; ++i_23) {
      ...
      for (int rv_2 = 0; rv_2 < 16; ++rv_2) {
        scores_max_clear_1[i_23] = max(scores_max_clear_1[i_23], acc_s[((((rv_2 & 7) * 4) + (i_23 * 2)) + (rv_2 >> 3))]);
      }
      scores_max_clear_1[i_23] = tl::AllReduce<tl::MaxOp, 4, 1, 0>::run(scores_max_clear_1[i_23]);
    ...
    for (int i_26 = 0; i_26 < 32; ++i_26) {
      acc_s[i_26] = exp2f(((acc_s[i_26] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_26 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_27 = 0; i_27 < 2; ++i_27) {
      ...
      for (int rv_3 = 0; rv_3 < 16; ++rv_3) {
        scores_sum[i_27] = (scores_sum[i_27] + acc_s[((((rv_3 & 7) * 4) + (i_27 * 2)) + (rv_3 >> 3))]);
      }
      scores_sum[i_27] = tl::AllReduce<tl::SumOp, 4, 1, 0>::run(scores_sum[i_27]);
    }
    #pragma unroll
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      logsum[i_28] = ((logsum[i_28] * scores_scale[i_28]) + scores_sum[i_28]);
    }
    #pragma unroll
    for (int i_29 = 0; i_29 < 8; ++i_29) {
      uint2 __2;
      float4 v__1 = *(float4*)(acc_s + (i_29 * 4));
      ...
      *(uint2*)(acc_s_cast + (i_29 * 4)) = __2;
    }
    #pragma unroll
    for (int i_30 = 0; i_30 < 64; ++i_30) {
      acc_o[i_30] = (acc_o[i_30] * scores_scale[((i_30 & 3) >> 1)]);
    }
    tl::cp_async_wait<1>();
    __syncthreads();
    for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
      for (int i_31 = 0; i_31 < 8; ++i_31) {
        int condval_12;
        if ((((int)bz) == 3)) {
          condval_12 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_12 = (actual_kv_seqlen >> 2);
        }
        int condval_13;
        if ((((int)bz) == 3)) {
          condval_13 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_13 = (actual_kv_seqlen >> 2);
        }
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((condval_13 + 63) & 127) >> 6) * 8192) + ((i_31 >> 2) * 4096)) + (ki_3 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_31 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_31 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 24576)])) + 0, B_local_1 + (i_31 * 8));
      }
  ...
  int condval_14;
  if ((((int)bz) == 3)) {
    condval_14 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
  } else {
    condval_14 = (actual_kv_seqlen >> 2);
  }
  if (1 <= condval_14) {
    #pragma unroll
    for (int i_32 = 0; i_32 < 8; ++i_32) {
      float broadcast_var_8 = 0x0p+0f/*0.000000e+00*/;
      *(float4*)(acc_s + (i_32 * 4)) = make_float4(broadcast_var_8, broadcast_var_8, broadcast_var_8, broadcast_var_8);
    }
    tl::cp_async_wait<0>();
    __syncthreads();
    for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
      ...
      for (int i_33 = 0; i_33 < 4; ++i_33) {
        int condval_15;
        if ((((int)bz) == 3)) {
          condval_15 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_15 = (actual_kv_seqlen >> 2);
        }
        int condval_16;
        if ((((int)bz) == 3)) {
          condval_16 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_16 = (actual_kv_seqlen >> 2);
        }
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((((condval_16 + 63) >> 6) + 1) & 1) * 8192) + ((ki_4 >> 2) * 4096)) + (i_33 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_4 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_33 * 8));
      }
    ...
    for (int i_34 = 0; i_34 < 32; ++i_34) {
      int condval_18;
      if ((((int)bz) == 3)) {
        condval_18 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
      } else {
        condval_18 = (actual_kv_seqlen >> 2);
      }
      int condval_19;
      if ((((int)bz) == 3)) {
        condval_19 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
      } else {
        condval_19 = (actual_kv_seqlen >> 2);
      }
      float condval_17;
      if ((((((((condval_18 + 63) >> 6) * 64) + ((i_34 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_34 & 1)) < (condval_19 + 64))) {
        condval_17 = acc_s[i_34];
      } else {
        condval_17 = -CUDART_INF_F;
      }
      acc_s[i_34] = condval_17;
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_9, broadcast_var_9);
    ...
    for (int i_35 = 0; i_35 < 2; ++i_35) {
      scores_max_clear_1[i_35] = -CUDART_INF_F;
      #pragma unroll
      for (int rv_4 = 0; rv_4 < 16; ++rv_4) {
        scores_max_clear_1[i_35] = max(scores_max_clear_1[i_35], acc_s[((((rv_4 & 7) * 4) + (i_35 * 2)) + (rv_4 >> 3))]);
      }
      scores_max_clear_1[i_35] = tl::AllReduce<tl::MaxOp, 4, 1, 0>::run(scores_max_clear_1[i_35]);
      scores_max[i_35] = max(scores_max[i_35], scores_max_clear_1[i_35]);
    }
    #pragma unroll
    ...
    for (int i_37 = 0; i_37 < 2; ++i_37) {
      scores_scale[i_37] = exp2f(((scores_max_prev[i_37] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_37] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_38 = 0; i_38 < 32; ++i_38) {
      acc_s[i_38] = exp2f(((acc_s[i_38] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_38 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_39 = 0; i_39 < 2; ++i_39) {
      ...
      for (int rv_5 = 0; rv_5 < 16; ++rv_5) {
        scores_sum[i_39] = (scores_sum[i_39] + acc_s[((((rv_5 & 7) * 4) + (i_39 * 2)) + (rv_5 >> 3))]);
      }
      scores_sum[i_39] = tl::AllReduce<tl::SumOp, 4, 1, 0>::run(scores_sum[i_39]);
    }
    #pragma unroll
    ...
    for (int i_41 = 0; i_41 < 8; ++i_41) {
      uint2 __3;
      float4 v__2 = *(float4*)(acc_s + (i_41 * 4));
      ...
      *(uint2*)(acc_s_cast + (i_41 * 4)) = __3;
    }
    #pragma unroll
    for (int i_42 = 0; i_42 < 64; ++i_42) {
      acc_o[i_42] = (acc_o[i_42] * scores_scale[((i_42 & 3) >> 1)]);
    }
    tl::cp_async_wait<0>();
    __syncthreads();
    for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
      for (int i_43 = 0; i_43 < 8; ++i_43) {
        int condval_20;
        if ((((int)bz) == 3)) {
          condval_20 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_20 = (actual_kv_seqlen >> 2);
        }
        int condval_21;
        if ((((int)bz) == 3)) {
          condval_21 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_21 = (actual_kv_seqlen >> 2);
        }
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((condval_21 + 63) >> 6) + 1) & 1) * 8192) + ((i_43 >> 2) * 4096)) + (ki_5 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_43 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_43 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 24576)])) + 0, B_local_1 + (i_43 * 8));
      }
  ...
  for (int i_44 = 0; i_44 < 64; ++i_44) {
    acc_o[i_44] = (acc_o[i_44] / logsum[((i_44 & 3) >> 1)]);
  }
  #pragma unroll
  for (int i_45 = 0; i_45 < 2; ++i_45) {
    logsum[i_45] = (log2f(logsum[i_45]) + (scores_max[i_45] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/));
  }
  if ((((int)threadIdx.x) % 4) == 0) {
    #pragma unroll
    for (int i_46 = 0; i_46 < 2; ++i_46) {
      if (((((((int)threadIdx.x) >> 5) * 8) + (i_46 * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 64) + (i_46 * 32)) + (((int)by) * 8)) + (((((int)threadIdx.x) & 31) >> 2) * 4)) + ((int)bz))] = ((bfloat16_t)logsum[i_46]);
      }
    }
  }
  __syncthreads();
  ...
  for (int i_47 = 0; i_47 < 32; ++i_47) {
    if (((((((int)threadIdx.x) >> 5) * 8) + ((i_47 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
      uint1 __4;
      float2 v__3 = *(float2*)(acc_o + (i_47 * 2));
      (reinterpret_cast<__nv_bfloat162*>(&__4))[0] = __float22bfloat162_rn(((float2*)(&v__3))[0]);
      *(uint1*)(O_shared_local_cast + 0) = __4;
      *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_47 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_47 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(O_shared_local_cast + 0);
    }
  }
  __syncthreads();
...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_2048_16_8_128__1(const int bx, const int by, const int bz,
                                                   const void* __restrict__ q, 
                                                   const void* __restrict__ k, 
                                                   const void* __restrict__ v,
                                                   const void* __restrict__ edge_ptr, 
  ...
  *(uint2*)(lse_local + 0) = *(uint2*)(glse + (((int)bx) * 4));
...
// Strategy: gqa_decode_tl_1_8192_2048_16_8_128
// selected_hparams: [64, 64, 4, 2, 128].
// smem: 0 bytes.
...
extern "C" int create_gqa_decode_tl_1_8192_2048_16_8_128(bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ K, bfloat16_t* __restrict__ V, int* __restrict__ edge, uint8_t* __restrict__ mask, bfloat16_t* __restrict__ glse, bfloat16_t* __restrict__ Output_partial, bfloat16_t* __restrict__ Output) {

	return 0;
}
#define LAUNCH_INFO_gqa_decode_tl_1_8192_2048_16_8_128 dim3(16, 1, 1), dim3(128, 1, 1), 0, stream

// latency: 0.06109 ms vs [ref-0.05543 sim-0.99986], idx: 22