  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  if (0 < condval_1) {
    ...
    for (int i_2 = 0; i_2 < 16; ++i_2) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_2 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(K[(((((((int64_t)i_2) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8))])), ((((((((int)threadIdx.x) >> 4) + (((int)bz) * (actual_kv_seqlen >> 2))) >> 3) + i_2) < 1024) && (0 <= (((i_2 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_3 = 0; i_3 < 16; ++i_3) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_3 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 24576)])), (&(V[(((((((int64_t)i_3) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8))])), ((((((((int)threadIdx.x) >> 4) + (((int)bz) * (actual_kv_seqlen >> 2))) >> 3) + i_3) < 1024) && (0 <= (((i_3 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
  }
  int condval_2;
  ...
  for (int k = 0; k < (((condval_2 + 127) >> 7) - 1); ++k) {
    #pragma unroll
    ...
    for (int ki = 0; ki < 8; ++ki) {
      ...
      for (int i_5 = 0; i_5 < 8; ++i_5) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((ki >> 2) * 8192) + (i_5 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_5 * 8));
      }
      for (int j = 0; j < 8; ++j) {
    ...
    for (int i_6 = 0; i_6 < 16; ++i_6) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_6 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(K[(((((((((int64_t)k) * (int64_t)131072) + (((int64_t)i_6) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)131072)])), ((((((k * 128) + (i_6 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8064) && (-128 <= ((((k * 128) + (i_6 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_7 = 0; i_7 < 64; ++i_7) {
      int condval_4;
      if ((((int)bz) == 3)) {
        condval_4 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
      } else {
        condval_4 = (actual_kv_seqlen >> 2);
      }
      float condval_3;
      if ((((((k * 128) + ((i_7 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1)) < condval_4)) {
        condval_3 = acc_s[i_7];
      } else {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_8 = 0; i_8 < 2; ++i_8) {
      ...
      for (int rv = 0; rv < 32; ++rv) {
        scores_max_clear[i_8] = max(scores_max_clear[i_8], acc_s[((((rv & 15) * 4) + (i_8 * 2)) + (rv >> 4))]);
      }
    ...
    for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
      for (int i_16 = 0; i_16 < 8; ++i_16) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((i_16 >> 2) * 8192) + (ki_1 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_16 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_16 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 24576)])) + 0, B_local_1 + (i_16 * 8));
      }
    ...
    for (int i_17 = 0; i_17 < 16; ++i_17) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_17 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 24576)])), (&(V[(((((((((int64_t)k) * (int64_t)131072) + (((int64_t)i_17) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)131072)])), ((((((k * 128) + (i_17 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8064) && (-128 <= ((((k * 128) + (i_17 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))));
    }
    tl::cp_async_commit();
  }
  int condval_5;
  ...
  if (1 <= condval_5) {
    ...
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      ...
      for (int i_19 = 0; i_19 < 8; ++i_19) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((ki_2 >> 2) * 8192) + (i_19 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_2 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_19 * 8));
      }
    ...
    for (int i_20 = 0; i_20 < 64; ++i_20) {
      ...
      float condval_6;
      if ((((((((condval_7 + 127) >> 7) * 128) + ((i_20 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_20 & 1)) < (condval_8 + 128))) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
    ...
    for (int i_21 = 0; i_21 < 2; ++i_21) {
      ...
      for (int rv_2 = 0; rv_2 < 32; ++rv_2) {
        scores_max_clear_1[i_21] = max(scores_max_clear_1[i_21], acc_s[((((rv_2 & 15) * 4) + (i_21 * 2)) + (rv_2 >> 4))]);
      }
    ...
    for (int i_25 = 0; i_25 < 2; ++i_25) {
      ...
      for (int rv_3 = 0; rv_3 < 32; ++rv_3) {
        scores_sum[i_25] = (scores_sum[i_25] + acc_s[((((rv_3 & 15) * 4) + (i_25 * 2)) + (rv_3 >> 4))]);
      }
    ...
    for (int ki_3 = 0; ki_3 < 8; ++ki_3) {
      for (int i_29 = 0; i_29 < 8; ++i_29) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((i_29 >> 2) * 8192) + (ki_3 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_29 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_29 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 24576)])) + 0, B_local_1 + (i_29 * 8));
      }
  ...
  if ((((int)threadIdx.x) % 4) == 0) {
    ...
    for (int i_32 = 0; i_32 < 2; ++i_32) {
      if (((((((int)threadIdx.x) >> 5) * 8) + (i_32 * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 64) + (i_32 * 32)) + (((int)by) * 8)) + (((((int)threadIdx.x) & 31) >> 2) * 4)) + ((int)bz))] = ((bfloat16_t)logsum[i_32]);
      }
    }
  }
  __syncthreads();
...
// selected_hparams: [128, 64, 4, 1, 128].
// smem: 0 bytes.
// use_cooperative_groups: 0.
// layout: (1, 8, 4), (128, 64, 4), (16, 1, 1), (128, 64, 4)
// block_dim=(128, 1, 1).
...
// latency: 0.06705 ms vs [ref-0.05521 sim-0.99989], idx: 33