...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_2048_16_8_128(const int bx, const int by, const int bz,
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  if (0 < valid_kv_seqlen) {
    ...
    for (int i_3 = 0; i_3 < 2; ++i_3) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 1024) + (i_3 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 14336)])), (&(V[((((i_3 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8))])));
    }
    tl::cp_async_commit();
  }
  if (16 < valid_kv_seqlen) {
    ...
    for (int i_5 = 0; i_5 < 2; ++i_5) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 1024) + (i_5 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 16384)])), (&(V[(((((i_5 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 16384)])));
    }
    tl::cp_async_commit();
  }
  if (32 < valid_kv_seqlen) {
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 1024) + (i_6 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 12288)])), (&(K[(((((i_6 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 32768)])));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_7 = 0; i_7 < 2; ++i_7) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((int)threadIdx.x) & 15) >> 3) * 1024) + (i_7 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 18432)])), (&(V[(((((i_7 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 32768)])));
    }
    tl::cp_async_commit();
  }
  for (int k = 0; k < (((valid_kv_seqlen + 15) >> 4) - 3); ++k) {
    #pragma unroll
    ...
    for (int ki = 0; ki < 8; ++ki) {
      ...
      tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((k % 3) * 2048) + ((ki >> 2) * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + 0);
    ...
    for (int i_9 = 0; i_9 < 2; ++i_9) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((k % 3) * 2048) + (((((int)threadIdx.x) & 15) >> 3) * 1024)) + (i_9 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(K[((((((((int64_t)k) * (int64_t)16384) + (((int64_t)i_9) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)49152)])), (k < 509));
    }
    tl::cp_async_commit();
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_11 = 0; i_11 < 2; ++i_11) {
      scores_max_clear[i_11] = -CUDART_INF_F;
      #pragma unroll
      for (int rv = 0; rv < 4; ++rv) {
        scores_max_clear[i_11] = max(scores_max_clear[i_11], acc_s[((((rv & 1) * 4) + (i_11 * 2)) + (rv >> 1))]);
      }
      scores_max_clear[i_11] = tl::AllReduce<tl::MaxOp, 4, 1, 0>::run(scores_max_clear[i_11]);
      scores_max[i_11] = max(scores_max[i_11], scores_max_clear[i_11]);
    }
    #pragma unroll
    ...
    for (int i_15 = 0; i_15 < 2; ++i_15) {
      ...
      for (int rv_1 = 0; rv_1 < 4; ++rv_1) {
        scores_sum[i_15] = (scores_sum[i_15] + acc_s[((((rv_1 & 1) * 4) + (i_15 * 2)) + (rv_1 >> 1))]);
      }
    ...
    for (int i_19 = 0; i_19 < 8; ++i_19) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((k % 3) * 2048) + ((i_19 >> 2) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_19 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_19 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 14336)])) + 0, B_local_1 + (i_19 * 8));
    }
    for (int j = 0; j < 8; ++j) {
    ...
    for (int i_20 = 0; i_20 < 2; ++i_20) {
      tl::cp_async_gs_conditional<16>((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((k % 3) * 2048) + (((((int)threadIdx.x) & 15) >> 3) * 1024)) + (i_20 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 14336)])), (&(V[((((((((int64_t)k) * (int64_t)16384) + (((int64_t)i_20) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)49152)])), (k < 509));
    }
    tl::cp_async_commit();
  }
  if (33 <= valid_kv_seqlen) {
    ...
    for (int i_21 = 0; i_21 < 2; ++i_21) {
      ...
      *(float4*)(acc_s + (i_21 * 4)) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
    }
    tl::cp_async_wait<2>();
    __syncthreads();
    for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
      ...
      tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((valid_kv_seqlen + 15) % 48) >> 4) * 2048) + ((ki_1 >> 2) * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_1 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_1 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + 0);
      tl::mma_sync<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + 0), reinterpret_cast<const unsigned*>(A_local + 0), reinterpret_cast<const unsigned*>(B_local + 0));
      tl::mma_sync<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + 4), reinterpret_cast<const unsigned*>(A_local + 0), reinterpret_cast<const unsigned*>(B_local + 4));
    }
    #pragma unroll
    for (int i_22 = 0; i_22 < 8; ++i_22) {
      float condval_2;
      if ((((((((valid_kv_seqlen + 15) >> 4) * 16) + ((i_22 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_22 & 1)) < (valid_kv_seqlen + 48))) {
        condval_2 = acc_s[i_22];
      } else {
        condval_2 = -CUDART_INF_F;
      }
      acc_s[i_22] = condval_2;
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
    ...
    for (int i_23 = 0; i_23 < 2; ++i_23) {
      ...
      for (int rv_2 = 0; rv_2 < 4; ++rv_2) {
        scores_max_clear_1[i_23] = max(scores_max_clear_1[i_23], acc_s[((((rv_2 & 1) * 4) + (i_23 * 2)) + (rv_2 >> 1))]);
      }
    ...
    for (int i_27 = 0; i_27 < 2; ++i_27) {
      ...
      for (int rv_3 = 0; rv_3 < 4; ++rv_3) {
        scores_sum[i_27] = (scores_sum[i_27] + acc_s[((((rv_3 & 1) * 4) + (i_27 * 2)) + (rv_3 >> 1))]);
      }
    ...
    for (int i_31 = 0; i_31 < 8; ++i_31) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((((valid_kv_seqlen + 15) % 48) >> 4) * 2048) + ((i_31 >> 2) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_31 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_31 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 14336)])) + 0, B_local_1 + (i_31 * 8));
    }
  ...
  if (17 <= valid_kv_seqlen) {
    ...
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      ...
      tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((((valid_kv_seqlen + 15) >> 4) + 1) % 3) * 2048) + ((ki_2 >> 2) * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_2 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + 0);
      tl::mma_sync<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + 0), reinterpret_cast<const unsigned*>(A_local + 0), reinterpret_cast<const unsigned*>(B_local + 0));
      tl::mma_sync<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + 4), reinterpret_cast<const unsigned*>(A_local + 0), reinterpret_cast<const unsigned*>(B_local + 4));
    }
    #pragma unroll
    for (int i_33 = 0; i_33 < 8; ++i_33) {
      float condval_3;
      if ((((((((valid_kv_seqlen + 15) >> 4) * 16) + ((i_33 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_33 & 1)) < (valid_kv_seqlen + 32))) {
        condval_3 = acc_s[i_33];
      } else {
        condval_3 = -CUDART_INF_F;
      }
      acc_s[i_33] = condval_3;
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_9, broadcast_var_9);
    ...
    for (int i_34 = 0; i_34 < 2; ++i_34) {
      ...
      for (int rv_4 = 0; rv_4 < 4; ++rv_4) {
        scores_max_clear_1[i_34] = max(scores_max_clear_1[i_34], acc_s[((((rv_4 & 1) * 4) + (i_34 * 2)) + (rv_4 >> 1))]);
      }
      scores_max_clear_1[i_34] = tl::AllReduce<tl::MaxOp, 4, 1, 0>::run(scores_max_clear_1[i_34]);
    ...
    for (int i_36 = 0; i_36 < 2; ++i_36) {
      scores_scale[i_36] = exp2f(((scores_max_prev[i_36] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_36] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_37 = 0; i_37 < 8; ++i_37) {
      acc_s[i_37] = exp2f(((acc_s[i_37] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_37 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_38 = 0; i_38 < 2; ++i_38) {
      ...
      for (int rv_5 = 0; rv_5 < 4; ++rv_5) {
        scores_sum[i_38] = (scores_sum[i_38] + acc_s[((((rv_5 & 1) * 4) + (i_38 * 2)) + (rv_5 >> 1))]);
      }
      scores_sum[i_38] = tl::AllReduce<tl::SumOp, 4, 1, 0>::run(scores_sum[i_38]);
    }
    #pragma unroll
    ...
    for (int i_40 = 0; i_40 < 2; ++i_40) {
      uint2 __3;
      float4 v__2 = *(float4*)(acc_s + (i_40 * 4));
      ...
      *(uint2*)(acc_s_cast + (i_40 * 4)) = __3;
    }
    #pragma unroll
    for (int i_41 = 0; i_41 < 64; ++i_41) {
      acc_o[i_41] = (acc_o[i_41] * scores_scale[((i_41 & 3) >> 1)]);
    }
    tl::cp_async_wait<1>();
    __syncthreads();
    for (int i_42 = 0; i_42 < 8; ++i_42) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((valid_kv_seqlen + 15) >> 4) + 1) % 3) * 2048) + ((i_42 >> 2) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_42 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_42 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 14336)])) + 0, B_local_1 + (i_42 * 8));
    }
  ...
  if (1 <= valid_kv_seqlen) {
    ...
    for (int i_43 = 0; i_43 < 2; ++i_43) {
      ...
      *(float4*)(acc_s + (i_43 * 4)) = make_float4(broadcast_var_10, broadcast_var_10, broadcast_var_10, broadcast_var_10);
    }
    tl::cp_async_wait<0>();
    __syncthreads();
    for (int ki_3 = 0; ki_3 < 8; ++ki_3) {
      tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((ki_3 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_3 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_3 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])) + 0, A_local + 0);
      tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((((valid_kv_seqlen + 15) >> 4) + 2) % 3) * 2048) + ((ki_3 >> 2) * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_3 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_3 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + 0);
      tl::mma_sync<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + 0), reinterpret_cast<const unsigned*>(A_local + 0), reinterpret_cast<const unsigned*>(B_local + 0));
      tl::mma_sync<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + 4), reinterpret_cast<const unsigned*>(A_local + 0), reinterpret_cast<const unsigned*>(B_local + 4));
    }
    #pragma unroll
    for (int i_44 = 0; i_44 < 8; ++i_44) {
      float condval_4;
      if ((((((((valid_kv_seqlen + 15) >> 4) * 16) + ((i_44 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_44 & 1)) < (valid_kv_seqlen + 16))) {
        condval_4 = acc_s[i_44];
      } else {
        condval_4 = -CUDART_INF_F;
      }
      acc_s[i_44] = condval_4;
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_11, broadcast_var_11);
    ...
    for (int i_45 = 0; i_45 < 2; ++i_45) {
      scores_max_clear_1[i_45] = -CUDART_INF_F;
      #pragma unroll
      for (int rv_6 = 0; rv_6 < 4; ++rv_6) {
        scores_max_clear_1[i_45] = max(scores_max_clear_1[i_45], acc_s[((((rv_6 & 1) * 4) + (i_45 * 2)) + (rv_6 >> 1))]);
      }
      scores_max_clear_1[i_45] = tl::AllReduce<tl::MaxOp, 4, 1, 0>::run(scores_max_clear_1[i_45]);
      scores_max[i_45] = max(scores_max[i_45], scores_max_clear_1[i_45]);
    }
    #pragma unroll
    ...
    for (int i_49 = 0; i_49 < 2; ++i_49) {
      ...
      #pragma unroll
      for (int rv_7 = 0; rv_7 < 4; ++rv_7) {
        scores_sum[i_49] = (scores_sum[i_49] + acc_s[((((rv_7 & 1) * 4) + (i_49 * 2)) + (rv_7 >> 1))]);
      }
    ...
    for (int i_51 = 0; i_51 < 2; ++i_51) {
      uint2 __4;
      float4 v__3 = *(float4*)(acc_s + (i_51 * 4));
    ...
    for (int i_53 = 0; i_53 < 8; ++i_53) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((valid_kv_seqlen + 15) >> 4) + 2) % 3) * 2048) + ((i_53 >> 2) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_53 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_53 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 14336)])) + 0, B_local_1 + (i_53 * 8));
    }
    for (int j_3 = 0; j_3 < 8; ++j_3) {
      tl::mma_sync<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + (j_3 * 8)), reinterpret_cast<const unsigned*>(acc_s_cast + 0), reinterpret_cast<const unsigned*>(B_local_1 + (j_3 * 8)));
      tl::mma_sync<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + ((j_3 * 8) + 4)), reinterpret_cast<const unsigned*>(acc_s_cast + 0), reinterpret_cast<const unsigned*>(B_local_1 + ((j_3 * 8) + 4)));
    }
  }
  #pragma unroll
  for (int i_54 = 0; i_54 < 64; ++i_54) {
    acc_o[i_54] = (acc_o[i_54] / logsum[((i_54 & 3) >> 1)]);
  }
  #pragma unroll
  for (int i_55 = 0; i_55 < 2; ++i_55) {
    logsum[i_55] = (log2f(logsum[i_55]) + (scores_max[i_55] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/));
  }
  __syncthreads();
  #pragma unroll
  for (int i_56 = 0; i_56 < 32; ++i_56) {
    if (((((((int)threadIdx.x) >> 5) * 8) + ((i_56 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
      uint1 __5;
      float2 v__4 = *(float2*)(acc_o + (i_56 * 2));
      (reinterpret_cast<__nv_bfloat162*>(&__5))[0] = __float22bfloat162_rn(((float2*)(&v__4))[0]);
      *(uint1*)(O_shared_local_cast + 0) = __5;
      *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_56 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_56 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(O_shared_local_cast + 0);
    }
  }
  __syncthreads();
...
// selected_hparams: [16, 64, 1, 3, 128].
// smem: 40960 bytes.
...
#define LAUNCH_INFO_gqa_decode_tl_1_8192_2048_16_8_128 dim3(1, 8, 1), dim3(128, 1, 1), 40960, stream

// latency: 0.07852 ms vs [ref-0.05951 sim-0.99995], idx: 2