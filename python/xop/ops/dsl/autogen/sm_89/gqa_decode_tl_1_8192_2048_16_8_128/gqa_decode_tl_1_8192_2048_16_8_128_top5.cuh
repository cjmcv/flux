  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  if (65 <= condval_6) {
    ...
    for (int i_22 = 0; i_22 < 32; ++i_22) {
      int condval_10;
      if ((((int)bz) == 1)) {
        condval_10 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 1)));
      } else {
        condval_10 = (actual_kv_seqlen >> 1);
      }
      int condval_11;
      if ((((int)bz) == 1)) {
  ...
  if (1 <= condval_14) {
    ...
    for (int i_34 = 0; i_34 < 32; ++i_34) {
      int condval_18;
      if ((((int)bz) == 1)) {
        condval_18 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 1)));
      } else {
        condval_18 = (actual_kv_seqlen >> 1);
      }
      int condval_19;
      if ((((int)bz) == 1)) {
  ...
  if ((((int)threadIdx.x) % 4) == 0) {
    ...
    for (int i_46 = 0; i_46 < 2; ++i_46) {
      if (((((((int)threadIdx.x) >> 5) * 8) + (i_46 * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 32) + (i_46 * 16)) + (((int)by) * 4)) + (((((int)threadIdx.x) & 31) >> 2) * 2)) + ((int)bz))] = ((bfloat16_t)logsum[i_46]);
      }
    }
  }
  __syncthreads();
...
// selected_hparams: [64, 64, 2, 2, 128].
// smem: 0 bytes.
...
// latency: 0.05733 ms vs [ref-0.05543 sim-0.99984], idx: 19