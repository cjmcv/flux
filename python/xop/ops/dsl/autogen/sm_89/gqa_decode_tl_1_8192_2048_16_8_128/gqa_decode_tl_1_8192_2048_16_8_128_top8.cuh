...
__device__ __forceinline__ void flashattn_kernel_1_8192_2048_16_8_128__0(const int bx, const int by, const int bz,
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  if (65 <= condval_7) {
    ...
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      ...
      for (int i_23 = 0; i_23 < 2; ++i_23) {
        ...
        int condval_9;
        if ((((int)bz) == 3)) {
          condval_9 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_9 = (actual_kv_seqlen >> 2);
        }
  ...
  if (33 <= condval_15) {
    ...
    for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
      ...
      for (int i_35 = 0; i_35 < 2; ++i_35) {
        ...
        int condval_17;
        if ((((int)bz) == 3)) {
          condval_17 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_17 = (actual_kv_seqlen >> 2);
        }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_9, broadcast_var_9);
    ...
    for (int ki_5 = 0; ki_5 < 2; ++ki_5) {
      for (int i_45 = 0; i_45 < 8; ++i_45) {
        ...
        int condval_22;
        if ((((int)bz) == 3)) {
          condval_22 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_22 = (actual_kv_seqlen >> 2);
        }
  ...
  int condval_23;
  if ((((int)bz) == 3)) {
    condval_23 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
  } else {
    condval_23 = (actual_kv_seqlen >> 2);
  }
  if (1 <= condval_23) {
    #pragma unroll
    ...
    for (int ki_6 = 0; ki_6 < 8; ++ki_6) {
      ...
      for (int i_47 = 0; i_47 < 2; ++i_47) {
        int condval_24;
        if ((((int)bz) == 3)) {
          condval_24 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_24 = (actual_kv_seqlen >> 2);
        }
        int condval_25;
        if ((((int)bz) == 3)) {
          condval_25 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_25 = (actual_kv_seqlen >> 2);
        }
    ...
    for (int i_48 = 0; i_48 < 16; ++i_48) {
      int condval_27;
      if ((((int)bz) == 3)) {
        condval_27 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
      } else {
        condval_27 = (actual_kv_seqlen >> 2);
      }
      int condval_28;
      if ((((int)bz) == 3)) {
        condval_28 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
      } else {
        condval_28 = (actual_kv_seqlen >> 2);
      }
      float condval_26;
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_11, broadcast_var_11);
    ...
    for (int ki_7 = 0; ki_7 < 2; ++ki_7) {
      for (int i_57 = 0; i_57 < 8; ++i_57) {
        int condval_29;
        if ((((int)bz) == 3)) {
          condval_29 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_29 = (actual_kv_seqlen >> 2);
        }
        int condval_30;
        if ((((int)bz) == 3)) {
          condval_30 = (actual_kv_seqlen - (((int)bz) * (actual_kv_seqlen >> 2)));
        } else {
          condval_30 = (actual_kv_seqlen >> 2);
        }
  ...
  if ((((int)threadIdx.x) % 4) == 0) {
    ...
    for (int i_60 = 0; i_60 < 2; ++i_60) {
      if (((((((int)threadIdx.x) >> 5) * 8) + (i_60 * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 64) + (i_60 * 32)) + (((int)by) * 8)) + (((((int)threadIdx.x) & 31) >> 2) * 4)) + ((int)bz))] = ((bfloat16_t)logsum[i_60]);
      }
    }
  }
  __syncthreads();
...
// selected_hparams: [32, 64, 4, 3, 128].
// smem: 0 bytes.
...
// latency: 0.06107 ms vs [ref-0.05542 sim-0.99976], idx: 11