class Qwen3MegaConfig06b:
    ...
    gqa_decode_layouts = {
        ...
        128: ((1, 8, 1), (32, 64, 1)),
        256: ((1, 8, 1), (64, 64, 1)),
        512: ((1, 8, 4), (32, 64, 4), (16, 1, 1), (32, 64, 4)),
        1024: ((1, 8, 2), (32, 64, 2), (16, 1, 1), (32, 64, 2)),
        2048: ((1, 8, 2), (32, 64, 2), (16, 1, 1), (32, 64, 2)),
    }
    gqa_decode_layout_shortkv = ((1, 8, 1), (32, 64, 1))
    gqa_decode_layout_longkv  = ((1, 8, 4), (32, 64, 4), (16, 1, 1), (32, 64, 4))
    gqa_decode_layout_split_point = 256
