...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_1024_16_8_128(const int bx, const int by, const int bz,
...
#define LAUNCH_INFO_gqa_decode_tl_1_8192_1024_16_8_128 dim3(1, 8, 1), dim3(128, 1, 1), 40960, stream

// latency: 0.0423 ms vs [ref-0.0361 sim-0.9998], idx: 2