...
template <typename T,
          ...
          int I_STRIDE,
          int O_STRIDE>
__device__ __forceinline__ void silu_mul_kernel_1_3072(const int bx, const int by, const int bz,
  ...
  for (int i_2 = 0; i_2 < 4; ++i_2) {
    ...
    float4 __2;
      ...
      float4 __3;
        ...
        float4 __4;
        float4 __5;
          float4 v__3 = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
          __5.x = (xi.x*v__3.x);
          __5.y = (xi.y*v__3.y);
          __5.z = (xi.z*v__3.z);
          __5.w = (xi.w*v__3.w);
...
extern "C" int create_silu_mul_tl_1_3072(bfloat16_t* __restrict__ A, bfloat16_t* __restrict__ C) {

	return 0;
}
#define LAUNCH_INFO_silu_mul_tl_1_3072 dim3(48, 1, 1), dim3(128, 1, 1), 12288, stream

// latency: 0.01149 ms vs [ref-0.02289 sim-1.0], idx: -1