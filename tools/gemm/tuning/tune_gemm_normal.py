...
def get_tuning_space(schema):
    space_G = [1]
    space_M = [1024,2048] #1,2,4,8,16,32,64,128,256,512,,1024,2048,4096,8192,16384,32768,65536 [8192] # list(range(1, 31)) # [8,16,32,64,128,512,1024] #, 2048, 4096   # , 16384
    space_NK = [(2560,9728), (6144,2560), (2560,4096), (19456,2560)] # qwen3_4b
